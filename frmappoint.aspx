<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmappoint.aspx.cs" Inherits="frmemployee" %>
    ...
    <div class="modal-body align-w3">
        ...
        <Columns>
              ...
              <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label7" runat="server" Text='<%#bind("puser") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
           ...
           <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label21" runat="server" Text='<%#bind("gender") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label23" runat="server" Text='<%#bind("mob") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField>
                       ...
                       <asp:Label ID="Label46" runat="server" Text="Action"></asp:Label>
                                ...
                                <ItemTemplate>
                                   <asp:LinkButton ID="LinkButton1" runat="server" CommandName="INS"  ForeColor="Green"  Font-Overline="false"  Text="Schedule" CommandArgument='<%# bind("ID")%>'></asp:LinkButton>

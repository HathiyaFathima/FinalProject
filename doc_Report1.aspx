<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doc_Report1.aspx.cs" Inherits="frmemployee" %>
    ...
    <div class="modal-body align-w3">
        <form  runat="server" enctype="multipart/form-data" >
         <div class="row sub-w3l my-3">
                ...
                <div class="col-md-6">
                    <label for="dop">Type of Disease:</label>
                                                 <asp:DropDownList ID="DropDownList2" 
                        runat="server"  class="form-control" AutoPostBack="true"   style="width: 300px; height: 40px" 
                        required onselectedindexchanged="DropDownList2_SelectedIndexChanged1">
        ...
        <Columns>
           ...
           <asp:TemplateField>
            ...
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="Label1120" runat="server" Text="Department"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                   <asp:Label ID="Label121" runat="server" Text='<%#bind("departmentname") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
           ...
           <asp:TemplateField>
            ...
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="Label9120" runat="server" Text="Consultancy Charge"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                   <asp:Label ID="Label321" runat="server" Text='<%#bind("consultancy_charge") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>

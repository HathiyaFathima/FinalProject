<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmfeedrep.aspx.cs" Inherits="frmemployee" %>
...
<body>
    ...
    <div class="modal-body align-w3">
        ...
        <Columns>
           ...
           <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="Label20" runat="server" Text="Feedback"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label21" runat="server" Text='<%#Eval("feedback")%>'   ></asp:Label>
                </ItemTemplate>

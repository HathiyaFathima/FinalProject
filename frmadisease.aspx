<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmadisease.aspx.cs" Inherits="frmemployee" %>
    ...
    <div class="modal-body align-w3">
        <form  runat="server" enctype="multipart/form-data" >
               <div class="row sub-w3l my-3">
                ...
                <div class="col-md-6">
                    <label for="dop">Disease Name:</label>
             ...
             <div class="row sub-w3l my-3">
                <div class="col-md-6">
                    <label for="dop">Symptoms of Disease:</label>
      ...
      <div class="row sub-w3l my-3">
                ...
                <div class="col-md-6">
                    <label for="dop">Type of Disease:</label>
                                                  <asp:TextBox ID="TextBox2" runat="server" style="width: 300px; height: 40px;" class="form-control" required></asp:TextBox>
                </div>

...
<body>
                    ...
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-right-sty mt-lg-0 mt-sm-4 mt-3">
                                ...
                                <a href="" class="reqe-button text-uppercase">Register</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    <!-- //breadcrumbs -->
    <!-- login  -->
    <section class="single_grid_w3_main align-w3-abt" id="about" style="     padding-top: 4px; padding-left:100px ">
        <div class="container">
        ...
        <form action="#" method="post" >
            ...
            <div class="form-group">
                <label for="ltype" class="col-form-label">Login Type</label>
               <asp:DropDownList ID="DropDownList2" runat="server"  class="form-control"   style="height: 40px" required>
